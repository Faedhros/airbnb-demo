...
import { SearchCircleIcon, SearchIcon, GlobeAltIcon, MenuIcon, UserCircleIcon, UsersIcon } from "@heroicons/react/solid"
    ...
    return (
        ...
        bg-white shadow-md py-5 px-5 md:px-10">
            ...
            <div className="flex items-center md:border-2 rounded-full py-2  md:shadow-md">
                <input type="text" placeholder="Start your search" className="flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400"></input>
